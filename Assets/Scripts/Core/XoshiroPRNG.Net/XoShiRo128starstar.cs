...
namespace Xoshiro.PRNG32 {
    ...
    public sealed class XoShiRo128starstar : Xoshiro32Base {
        ...
        public XoShiRo128starstar(long seed) {
            UInt32[] s = new UInt32[NUM_STATES];
        ...
        /// initial state</param>
        public XoShiRo128starstar(UInt32[] initialStates) {
        ...
        public override uint NextU() {
            ...
            UInt32 r1 = (s1 << 2) + s1;          // * 5 step
            UInt32 r2 = (r1 << 7) | (r1 >> 25);  // shift left | shift right step
            UInt32 rslt = (r2 << 3) + r2;        // * 9 step
