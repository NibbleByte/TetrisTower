...
namespace Xoshiro.Base {
    ...
    abstract public class XoshiroBase : Random {
        ...
        public ulong Next64U(ulong maxValue) {
            ...
            // Debiasing
            UInt64 r = UInt64.MaxValue / maxValue;
            UInt64 tooLarge = r * maxValue;
            do {
                r = this.Next64U();
            } while(r >= tooLarge);
            return r % maxValue;
        ...
        public long Next64() {
            ...
            // if we don't do this, casting to Int64 might result in negative numbers.
            return (Int64)(this.Next64U() & 0x7FFFFFFFFFFFFFFF);
        }
        ...
        public long Next64(long maxValue) {
            if(maxValue <= 1) throw new ArgumentOutOfRangeException(
               nameof(maxValue), maxValue, "maxValue must be > 1");
            // Debiasing
            Int64 r = Int64.MaxValue / maxValue;
            Int64 tooLarge = r * maxValue;
            do {
                r = this.Next64();
            } while(r >= tooLarge);
            return r % maxValue;
        ...
        public long Next64(long minValue, long maxValue) {
            if(minValue + 1 >= maxValue)
                throw new ArgumentException("minValue must be < maxValue-1!");
            UInt64 rsz = (UInt64)(maxValue - minValue);
        ...
        #endregion UInt32 Methods

        #region System.Random-compatible (Int32 with notes)
        ...
        public override int Next(int minValue, int maxValue) {
            ...
            UInt32 raw = NextU((UInt32)(maxValue - minValue));
        ...
        #endregion System.Random-compatible (Int32 with notes)
