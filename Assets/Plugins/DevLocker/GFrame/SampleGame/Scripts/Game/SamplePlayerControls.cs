...
//     version 1.1.0
//     from Assets/Plugins/DevLocker/GFrame/SampleGame/Prefabs/SamplePlayerControls.inputactions
//
...
namespace DevLocker.GFrame.SampleGame.Game
{
    ...
    ""controlSchemes"": [
        ...
        {
            private @SamplePlayerControls m_Wrapper;
            public UIActions(@SamplePlayerControls wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @SamplePlayerControls m_Wrapper;
            public CommonHotkeysActions(@SamplePlayerControls wrapper) { m_Wrapper = wrapper; }
